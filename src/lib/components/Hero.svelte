...
<header>
    <div class="relative h-180 w-full bg-cover bg-center" style={`background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0), rgba(0, 0, 0, 0)), url('${src}');`}>
        <div class="flex justify-between max-w-300 items-end h-full mx-auto">
            <div class="absolute -top-14 left-100 flex flex-col justify-center h-full text-left text-white">
            ...
            <div class="absolute top-60 right-100">
                <form 
                    name="contact" 
                    method="post" 
                    data-netlify="true"
        ...
        <div class="absolute left-0 top-134 w-full overflow-hidden rotate-180">
            <svg class="block relative" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
